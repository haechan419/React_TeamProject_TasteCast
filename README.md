...
> 사용자의 취향과 실시간 날씨에 따라 맞춤형 레시피를 추천하는 기능입니다.

- ✅ 좋아하는 음식만 보기  
- 🚫 싫어하는 재료 제외  
- 🌤️ 현재 날씨 기반 레시피 자동 필터링  
...
> 초기 렌더링 속도 개선과 렌더링 효율 향상을 위한 다양한 최적화 기법을 적용했습니다.
...
이번 프로젝트 **「오늘 뭐 먹지」** 는 **날씨와 개인 취향을 반영한 맞춤형 레시피 추천 웹 애플리케이션**을 목표로 개발되었습니다.  
