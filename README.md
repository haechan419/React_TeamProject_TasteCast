...
프로젝트에서 적용한 성능 최적화 사례를 Before / After 이미지로 확인할 수 있습니다.
...
- **적용 기술/방법**
  - **React-Virtualized**: 다수 데이터 렌더링 시 성능 향상
  - 이미지 및 컴포넌트 지연 로딩으로 불필요한 렌더링 방지


---

### ⚡ 코드 스플리팅
- **lazy** + **Suspense**를 사용하여 이미지가 많은 페이지의 초기 로딩 속도 개선
